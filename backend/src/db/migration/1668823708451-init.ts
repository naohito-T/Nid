...
export class init1668823708451 implements MigrationInterface {
    name = 'init1668823708451'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_authorizations" ADD CONSTRAINT "FK_19b85905fd1c7e6432323a0e352" FOREIGN KEY ("user_Id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_authorizations" DROP CONSTRAINT "FK_19b85905fd1c7e6432323a0e352"`);
